        ...
        <div class="">
          <div className="ready">
            ...
            <div class="box-container1">
              <div class="box1">
                <li>
                  <a href="#">Advertise/Market Your Property</a>
                </li>
                <li>
                  <a href="#">Featured Real Estate Companies</a>
                </li>
                <li>
                  <a href="#">Place Banner Adverts</a>
                </li>
                <li>
                  <a href="#">Investor Relation</a>
                </li>
                <li>
                  <a href="#">Afiliate Programs</a>
                </li>
                <li>
                  <a href="#">Customer interaction/relationship</a>
                </li>
              </div>
              ...
              <div class="box1">
                ...
                <li>
                  <a href="#">Property Demand Trends</a>
                </li>
                <li>
                  <a href="#">Average Property Prices</a>
                </li>
                <li>
                  <a href="#">Mortage buildings</a>
                </li>
              </div>
